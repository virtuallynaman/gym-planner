                ...
                <div className="max-w-xl mx-auto">
                    {!isGenerating ? (
                        <Card variant="bordered">
                            ...
                            <p className="mb-6 text-muted">Help us create the perfect plan for you.</p>
                            <form onSubmit={handleQuestionnaire} className="space-y-5">
                                ...
                                <div className="flex gap-3 pt-2">
                                    <Button type="submit" className="flex-1 gap-2">Generate My Plan <ArrowRight className="w-5 h-5" /></Button>
                                </div>
                            </form>
                        </Card>
                    ) : (
                        <Card variant="bordered" className="text-center py-16">
                            ...
                            <p className="text-muted">Our AI is building your personalised training program...</p>
                        </Card>
                    )}
                </div>
            </div>
